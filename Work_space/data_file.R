...
biais_model1_unscale <- mpi_biais_tas-mpi_biais_pr
biais_model1_unscale_winter <- mpi_biais_tas_winter-mpi_biais_pr_winter
biais_model1_unscale_summer <- mpi_biais_tas_summer-mpi_biais_pr_summer
biais_model1_unscale_spring <- mpi_biais_tas_spring-mpi_biais_pr_spring
biais_model1_unscale_fall <- mpi_biais_tas_fall-mpi_biais_pr_fall

biais_model2_unscale <- cnrm_biais_tas-cnrm_biais_pr
biais_model2_unscale_winter <- cnrm_biais_tas_winter-cnrm_biais_pr_winter
biais_model2_unscale_summer <- cnrm_biais_tas_summer-cnrm_biais_pr_summer
biais_model2_unscale_spring <- cnrm_biais_tas_spring-cnrm_biais_pr_spring
biais_model2_unscale_fall <- cnrm_biais_tas_fall-cnrm_biais_pr_fall

biais_model3_unscale <- ipsl_biais_tas-ipsl_biais_pr
biais_model3_unscale_winter <- ipsl_biais_tas_winter-ipsl_biais_pr_winter
biais_model3_unscale_summer <- ipsl_biais_tas_summer-ipsl_biais_pr_summer
biais_model3_unscale_spring <- ipsl_biais_tas_spring-ipsl_biais_pr_spring
biais_model3_unscale_fall <- ipsl_biais_tas_fall-ipsl_biais_pr_fall
...
lon_eur_ipsl = c((lon_ipsl[454:480]-360),lon_ipsl[1:81])
lat_eur_ipsl = lat_ipsl[167:221]                     
...
lon_eur_mpi = c((lon_mpi[454:480]-360),lon_mpi[1:81])
lat_eur_mpi = lat_mpi[167:221]                     
...
lon_eur_erai = c((lon_erai[454:480]-360),lon_erai[1:81])
lat_eur_erai = lat_erai[167:221]
...
pr_eur_erai <- rbind(pr_erai[454:480,167:221],pr_erai[1:81,167:221])-273.15
...
# Zlim
eur_biais = c(biais_model1_eur_winter,biais_model2_eur_winter,biais_model3_eur_winter)
